...
"""
Ce module est utilisé à deux emplacements du projet :
...
def donneesFud():
    ...
    fud = []
    with open("./tables/20220408_exportFuD_principal.csv") as csvf:
    ...
    with open("./tables/20220408_exportFuD_complement.csv") as csvf:
        lecteur = csv.DictReader(csvf, delimiter='\t', quotechar="|")
        # On inscrit dans la liste fud des dictionnaires décrivant les attributs des enregistrements
        for index, ligne in enumerate(lecteur):
            enregistrement = {}
...
def donneesZenodo():
    zenodo = {}
    with open("./tables/20211116_Constance_de_Salm_Korrespondenz_Inventar_Briefe.csv") as csvf:
        lecteur = csv.DictReader(csvf, delimiter='\t', quotechar="|")
    ...
    with open("./tables/20211116_Constance_de_Salm_Korrespondenz_Inventar_weitere_Quellen.csv") as csvf:
        lecteur = csv.DictReader(csvf, delimiter='\t', quotechar="|")
