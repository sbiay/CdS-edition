...
\begin{document}
	...
	\chapter[HTR~: état des lieux]{Reconnaissance automatique des écritures manuscrites \\ \large Un état des lieux}
		...
		intitulé \textit{Documents anciens et reconnaissance automatique des
			...
			Stokes. \cite{DocumentsAnciensReconnaissance}}.
		...
		projet \gls{cremma}-Lab~: favoriser une réflexion sur la meilleure façon de
