		...
		\section[La segmentation]{La segmentation~: reconnaissance des zones de texte et des lignes d'écriture}
			...
			\subsection{Principes et enjeux}
				...
				\begin{figure}[!h]
					...
					\caption{Segmentation par le modèle par défaut de Kraken (lettre absente de l'inventaire en ligne, détail du cliché CdS02\_Konv002-02\_0065.jpg).}
					\label{seg-defaut-65}
				\end{figure}
		    ...
		    \subsection{Problèmes posés par la mise en page des lettres}
				...
				\begin{figure}[!h]
					...
					\caption{Mise en page aérée au début d'une lettre (lettre absente de l'inventaire en ligne, détail du cliché CdS02\_Konv002-02\_0193.jpg).}%
					\label{}
				\end{figure}
				...
				\begin{figure}[!h]
					...
					\caption{Mise en page resserrée au début d'une lettre (lettre absente de l'inventaire en ligne, détail du cliché CdS02\_Konv002-02\_0046.jpg).}%
					\label{}%
				\end{figure}
			...
			\subsection{Analyser le comportement du modèle de segmentation par défaut d'eScriptorium}
