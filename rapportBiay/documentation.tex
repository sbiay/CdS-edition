...
\title{Chaîne de traîtement pour l'édition numérique de la correspondance manuscrite de Constance de Salm (1767-1845)}
...
\begin{document}
	...
	\chapter*{Résumé}
		...
		\textbf{Informations bibliographiques~:} Sébastien Biay, \textit{Chaîne de traîtement pour l'édition numérique de la correspondance manuscrite de Constance de Salm (1767-1845)}, mémoire de master \og{}Technologies numériques appliquées à l'histoire\fg{}, dir. Mareike König, Ariane Pinche, École nationale des chartes, 2022.
	...
	\addcontentsline{toc}{chapter}{Introduction}% Ajoute à la table des matières sans numérotation
		...
		\section*{Le contexte}
			...
			Cette correspondance, principalement conservée dans les archives de la Société des amis du Vieux Toulon et de sa région (Toulon), a suscité l'intérêt des chercheurs du \gls{dhi} en 2010, date à laquelle le fonds de la société a été numérisé\footcite{peyronnet-drydenSalonVirtuelInventaire2012, ProposProjet}. Coordonné par Florence de Peyronnet-Dryden, un groupe de recherche%
			...
			\footnote{\url{https://fud.uni-trier.de/}} entre 2011 et 2013. L'accès aux données était alors possible aux chercheurs sur inscription.%
			
			Suite à la découverte d'une partie complémentaire au fonds de Toulon, racheté par la famille Salm-Reifferscheidt-Dyck et aujourd'hui conservée dans les archives du château de Dyck, le nombre des pièces inventoriées a été porté entre 2014 et 2015 à environ 11\,000%
			...
			un travail réalisé par Hyppolyte Souvay à l'occasion d'un stage pour l'obtention du master Humanités numériques de l'\gls{enc}\footcite{souvayCorrespondanceConstanceSalm2021}.
		...
		\section*{Les objectifs}
			...
			Deux facteurs ont joué en faveur de la réussite de cette mission~: d'une part l'initiation aux principes de l'\gls{htr} et la prise en main du logiciel eScriptorium dans le cadre des cours du master Technologies numériques appliquées à l'histoire, et d'autre part le recours aux instruments et à la documentation produits par le projet \gls{dahn}, fondé sur l'édition de la correspondance de Paul d’Estournelles de Constant (1852-1924), dont les responsables scientifiques et techniques --- Anne Baillot, professeur en Études Germaniques à l'Université du Mans, et Floriane Chiffoleau, diplômée du master et doctorante en humanités numériques (\gls{inria}) --- se sont associées à l'encadrement de ce stage\footcite{chiffoleauDAHNProject}.
